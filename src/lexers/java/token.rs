...
pub fn get_keyword_token(identifier: &Vec<char>) -> Result<Token, String> {
    ...
    match &id[..] {
        ...
        "ArrayList" => Ok(Token::CONSTANT(identifier.to_vec())),
        "Arrays" => Ok(Token::CONSTANT(identifier.to_vec())),
        "Map" => Ok(Token::CONSTANT(identifier.to_vec())),
        "HashMap" => Ok(Token::CONSTANT(identifier.to_vec())),
        "LinkedHashSet" => Ok(Token::CONSTANT(identifier.to_vec())),
