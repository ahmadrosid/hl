...
"True"|"False"|"None"|"not"|"in"|"self" => Ok(Token::CONSTANT(identifier.clone())),"as"|"and"|"assert"|"async"|"await"|"break"|"case"|"class"|"continue"|"else"|"elif"|"except"|"def"|"del"|"finally"|"for"|"from"|"global"|"if"|"is"|"import"|"lambda"|"match"|"nonlocal"|"or"|"pass"|"print"|"raise"|"return"|"try"|"type"|"with"|"while"|"yield" => Ok(Token::KEYWORD(identifier.clone())),_ => Err(String::from("Not a keyword")),}}
