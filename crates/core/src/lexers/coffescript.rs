...
pub fn get_keyword_token(identifier: &Vec<char>) -> Result<Token, String> {
    ...
    match &id[..] {
        "true" | "false" | "yes" | "no" | "on" | "off" => Ok(Token::CONSTANT(identifier.clone())),
        "await" | "when" | "catch" | "continue" | "debugger" | "default" | "by" | "until"
        | "delete" | "do" | "else" | "export" | "finally" | "for" | "class" | "extends"
        | "while" | "then" | "get" | "if" | "import" | "from" | "in" | "instanceof" | "new"
        | "reject" | "resolve" | "return" | "set" | "super" | "switch" | "this" | "throw"
        | "try" | "typeof" | "with" | "yield" | "unless" => Ok(Token::KEYWORD(identifier.clone())),
